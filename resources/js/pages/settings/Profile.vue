                    ...
                    >
                        <div class="grid gap-6">
                            <div class="grid gap-2">
                                <Label for="nama_lengkap" class="text-slate-700 dark:text-slate-300"
                                    >Nama lengkap</Label
                                >
                                <Input
                                    id="nama_lengkap"
                            ...
                            <div class="grid gap-2">
                                <Label for="username" class="text-slate-700 dark:text-slate-300"
                                    >Username</Label
                                >
                                <Input
                                    id="username"
                            ...
                            <div class="grid gap-2">
                                <Label for="role" class="text-slate-700 dark:text-slate-300"
                                    >Peran</Label
                                >
                                <select
                                    ...
                                    id="role"
                                    v-model="formRoleId"
                                    class="border-input flex h-9 w-full rounded-md border bg-white px-3 py-1 text-sm shadow-xs dark:bg-slate-800 dark:border-slate-700 dark:text-slate-100"
                                >
                                    <option
                                        v-for="r in roles"
                                        :key="r.id_role"
                                ...
                                <Input
                                    ...
                                    disabled
                                    class="bg-slate-50 dark:bg-slate-800/50 dark:border-slate-700 dark:text-slate-400"
                                />
                                <p
                                    v-if="!(pos.isSuper || pos.isDev)"
                            ...
                            <button
                                type="submit"
                                class="mt-2 w-full rounded-xl bg-blue-700 py-2.5 text-sm font-bold text-white hover:bg-blue-800 disabled:opacity-60 dark:bg-blue-600 dark:hover:bg-blue-500"
                                :disabled="saving"
                            >
