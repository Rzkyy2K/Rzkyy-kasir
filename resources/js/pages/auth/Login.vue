...
<template>
    ...
    <div class="relative flex min-h-svh w-full flex-col lg:flex-row overflow-x-hidden bg-white dark:bg-slate-950 font-sans">
        ...
        <!-- ================================================================= -->
        <div
            class="relative flex w-full flex-col justify-between overflow-hidden bg-gradient-to-br from-[#0c2356] via-[#143f91] to-[#1e58c8] px-6 py-8 text-white sm:px-10 md:px-14 lg:w-[52%] xl:w-[54%] 2xl:w-[56%] lg:min-h-svh lg:py-12"
        >
            ...
            <!-- Header Sisi Kiri: Logo Scholify -->
            <div class="relative z-10 flex items-center justify-between">
                <Link href="/login" class="flex items-center gap-3 transition hover:opacity-90">
                    <div class="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white p-1 shadow-lg shadow-black/20 border border-white/25 transition-transform hover:scale-105">
                        <img
            ...
            <div class="relative z-10 my-auto py-10 lg:max-w-xl">
                <!-- Sparkle Badge Mewah -->
                <div class="inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-indigo-500/20 px-4 py-1.5 shadow-lg shadow-cyan-500/10 backdrop-blur-md">
                ...
                <div class="mt-8 grid grid-cols-3 gap-3 sm:gap-4 pt-2">
                    <!-- Fitur 1: Kasir Cepat -->
                    <div class="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-3.5 sm:p-4 shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white/30 hover:bg-white/15 hover:shadow-xl">
            ...
            <div class="relative z-30 flex flex-wrap items-center justify-between gap-2 border-t border-white/15 pt-5 pr-1 lg:pr-24 xl:pr-28 text-xs text-blue-200/80">
                <p class="font-medium">
        ...
        <!-- ================================================================= -->
        <!-- 2. SISI KANAN: FORM LOGIN DENGAN GELOMBANG PEMISAH DI UJUNGNYA    -->
        <!-- ================================================================= -->
        <div
            class="relative flex flex-1 flex-col justify-center bg-white px-6 py-12 sm:px-10 md:px-14 lg:px-16 xl:px-20 dark:bg-slate-950"
        >
            <!-- ------------------------------------------------------------- -->
            ...
            <!-- GELOMBANG PEMISAH HORIZONTAL (MOBILE / LAYAR KECIL) -->
            <div class="pointer-events-none absolute -top-10 left-0 right-0 h-12 w-full overflow-hidden block lg:hidden z-20">
                <svg class="h-full w-[200%] mobile-wave-track" viewBox="0 0 1200 80" preserveAspectRatio="none">
                    <path
                        d="M 0,80 
                           L 0,35 
            ...
            <!-- Kontainer Form Login (Bersih, Elegan, Modern seperti Referensi) -->
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <h2 class="mt-6 text-2xl sm:text-3xl font-black tracking-tight text-slate-900 dark:text-white">
                        Welcome Back!
                    </h2>
